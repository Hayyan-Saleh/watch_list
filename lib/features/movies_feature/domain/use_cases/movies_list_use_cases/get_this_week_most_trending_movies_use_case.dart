...
class GetThisWeekMostTrendingMoviesUseCase {
  final MoviesListRepository moviesListRepository;
  const GetThisWeekMostTrendingMoviesUseCase(
      {required this.moviesListRepository});

  Future<Either<Failure, List<Movie>>> call() async {
    return await moviesListRepository.getThisWeekMostTrendingMovies();
  }
}
