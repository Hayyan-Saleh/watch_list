...
class GetTodayMostTrendingMoviesUseCase {
  final MoviesListRepository moviesListRepository;
  const GetTodayMostTrendingMoviesUseCase({required this.moviesListRepository});

  Future<Either<Failure, List<Movie>>> call() async {
    return await moviesListRepository.getTodayMostTrendingMovies();
  }
}
